...
//# buildInfo:effects=false, kind=exe, use-js-string=true, version=5.4.0+git-2d765db
(function
  (Object){
      ...
      case 5:
       ...
       for(;;){
        if(i$0 === len)
         ...
         var _fB_ = caml_string_get(str, i$0) - 46 | 0;
         a:
         {
          if(23 < _fB_ >>> 0){
           if(55 === _fB_) break a;
          }
          else if(21 < _fB_ - 1 >>> 0) break a;
    ...
    for(;;){
     a:
     {
      if(param){
       ...
       b:
       {
        try{var val = caml_call1(hd, e);}catch(_fm_){break b;}
     ...
     var
      ...
      next =
        function(param){
         i$2[1]++;
         var _dh_ = i$2[1];
         return caml_check_bound(methods, _dh_)[1 + _dh_];
        },
      clo = next(0);
        ...
        case 19:
         var
          ...
          element =
            function(n, m){
              return function(obj){
               var _df_ = caml_call1(obj[1][1 + m], obj);
               return caml_call2(obj[1][1 + n], obj, _df_);};
             }
             (n$15, m$1);
         break;
        case 20:
         ...
         var
          element =
            function(m, n){
              return function(obj){
               var _de_ = obj[1 + n];
               return caml_call1(caml_get_public_method(_de_, m, 0), _de_);};
             }
             (m$3, n$16);
         break;
        case 22:
        ...
        default:
         ...
         var
          element =
            function(m, n){
              return function(obj){
               var _dg_ = caml_call1(obj[1][1 + n], obj);
          ...
          handler
           (function(param$0){
             ...
             var
              ...
              t = match$0[1],
              d = 500.;
             function callback(_dT_){return wakeup(w$0, _dT_);}
             var id = [0, 0];
             function loop(d, param){
              ...
              var
               cb =
                 remain == 0.
                  ? callback
                  : function(_dS_){return loop(remain, _dS_);};
             ...
             function _dm_(s){
              ...
              function update_view(force){
               ...
               var
                _dM_ =
                  caml_call1
                   (caml_get_public_method(hadj, 307110897, 372), hadj),
                mv = st[6] - _dM_;
               if
                (caml_call1
                  (caml_get_public_method(hadj, 834174833, 373), hadj)
                 < 0.)
                caml_call2
               ...
               if
                (mv
                 <
                  caml_call1
                   (caml_get_public_method(hadj, 834174833, 375), hadj))
                caml_call2
                 (caml_get_public_method(hadj, -659372076, 376), hadj, mv);
               var _dN_ = [0, min(ah, st[7])];
               caml_call7
               ...
               var
                _dO_ =
                  caml_call1
                   (caml_get_public_method(vadj, 307110897, 378), vadj),
                mv$0 = st[7] - _dO_;
               if
                (caml_call1
                  (caml_get_public_method(vadj, 834174833, 379), vadj)
                 < 0.)
                caml_call2
              ...
              function rescale(x, y){
               var
                ...
                _dJ_ =
                  caml_call1
                   (caml_get_public_method(hadj, 307110897, 386), hadj)
                  * r
                  * x;
               caml_call2
                (caml_get_public_method(hadj, -659372076, 388),
                 hadj,
                 caml_call1
                  (caml_get_public_method(hadj, 834174833, 387), hadj)
                 + _dJ_);
               var
                _dK_ =
                  caml_call1
                   (caml_get_public_method(vadj, 307110897, 389), vadj)
                  * r
                  * y;
               caml_call2
                (caml_get_public_method(vadj, -659372076, 391),
                 vadj,
                 caml_call1
                  (caml_get_public_method(vadj, 834174833, 390), vadj)
                 + _dK_);
               prev_scale[1] = scale;
               var p = st[8];
               p[4] = empty_rectangle;
              ...
              function set_slider_position(pos$0){
               ...
               caml_call2
                 ...
                 *
                  caml_call1
                   (caml_get_public_method(sadj, 675223906, 411), sadj)
                 / 284);
              ...
              function bump_scale(x, y, v){
               var
                ...
                prev =
                  caml_call1
                   (caml_get_public_method(sadj, 834174833, 429), sadj),
                _dE_ =
                  prev
                  +
                   v
               ...
               (canvas,
                ...
                handler
                 (function(t176){
                   ...
                   get(t176.wheelDeltaX, _dB_);
                   function _dC_(param){return t176.wheelDelta;}
                   var
                    dy = (- get(t176.wheelDeltaY, _dC_) | 0) / 40 | 0,
             ...
             try{
              var
               _dk_ = return$0(caml_read_file_content(cst_scene_json)),
               _dn_ = _dk_;
             }
             catch(_do_){
              var _dj_ = caml_wrap_exception(_do_);
              if(_dj_ !== Not_found)
              ...
              for(;;){
               if(! param){
                var
                 headers =
                   function(s){
                    function _du_(v){return [0, caml_string_of_jsstring(v)];}
                    function _dv_(param){return 0;}
                    return case$0
                         ...
                         var
                          ...
                          _dp_ =
                            function(param){
                             ...
                             var match = case$0(x, function(param){return 0;}, _dt_);
                             if(! match) return 0;
                             var doc = match[1];
                             return doc.documentElement === no_handler ? 0 : [0, doc];
                            },
                          _dq_ = caml_string_of_jsstring,
                          _dr_ = function(param){return _cE_;},
                          response =
                            [0,
                             url,
                             code,
                             headers,
                             case$0(req.responseText, _dr_, _dq_),
                             _dp_];
