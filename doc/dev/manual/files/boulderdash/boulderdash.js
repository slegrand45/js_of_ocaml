      ...
      case 5:
       ...
       for(;;){
        if(i$0 === len)
         ...
         var _fO_ = caml_string_get(str, i$0) - 46 | 0;
         a:
         {
          if(23 < _fO_ >>> 0){
           if(55 === _fO_) break a;
          }
          else if(21 < _fO_ - 1 >>> 0) break a;
    ...
    for(;;){
     a:
     {
      if(param){
       ...
       b:
       {
        try{var val = caml_call1(hd, e);}catch(_fz_){break b;}
     ...
     a:
     {
      ...
      if(0 <= i$1 && lim >= i$1){
       ...
       for(;;){
        ...
        if(caml_string_unsafe_get(path_string, i) === c){var _e5_ = i; break a;}
        var i$0 = i + 1 | 0, i = i$0;
       }
      }
      var _e5_ = invalid_arg(_o_);
     }
     var j = _e5_;
    }
    catch(_e6_){
    ...
    function _di_(param){
     ...
     function update(param, next, img, over_cont, out_cont, click_cont){
      ...
      for(;;){
       ...
       a:
       {
        if(5 !== param$1 && 3 <= param$1){var _dK_ = 0; break a;}
        var _dK_ = 1;
       }
       if(_dK_){
        var
             ...
             handler
              (function(param$0){
                ...
                if(_cM_){
                 ...
                 for(;;){
                  if(! param){var _cN_ = i < len ? 1 : 0; break;}
                  var
                   l = param[2],
                   len$0 = len + 1 | 0,
                   len = len$0,
                ...
                if(_cN_){
                 if(0 <= i){
                  var l$0 = levels, n = i;
                  for(;;){
                   if(! l$0){var _cO_ = failwith(_j_); break;}
                   var l$1 = l$0[2], a = l$0[1];
                   if(0 === n){var _cO_ = a; break;}
