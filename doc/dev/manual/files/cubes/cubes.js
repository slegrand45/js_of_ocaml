...
(function(globalThis){
      ...
      case 5:
       ...
       for(;;){
        if(i$0 === len)
         ...
         var _dj_ = caml_string_get(str, i$0) - 46 | 0;
         a:
         {
          if(23 < _dj_ >>> 0){
           if(55 === _dj_) break a;
          }
          else if(21 < _dj_ - 1 >>> 0) break a;
    ...
    for(;;){
     a:
     {
      if(param){
       ...
       b:
       {
        try{var val = caml_call1(hd, e);}catch(_c6_){break b;}
   ...
   function wakeup(r, v){
    var result$0 = [0, v], p = underlying(r), _cB_ = p[1];
    switch(_cB_[0]){
      case 1:
    ...
    for(;;){
     ...
     for(;;)
      for(;;){
       ...
       var _cr_ = k$1 + 1 | 0;
       if(11 !== k$1){var k$1 = _cr_; break;}
       var _cp_ = i$1 + 1 | 0;
       if(11 !== i$1){var i$1 = _cp_; break a;}
       var j$0 = 0;
       for(;;){
        var i$0 = [0, 11], k$0 = 0;
        b:
        for(;;)
         for(;;){
          ...
          var _co_ = k$0 + 1 | 0;
          if(11 !== k$0){var k$0 = _co_; break;}
          var _cm_ = j$0 + 1 | 0;
          if(11 !== j$0){var j$0 = _cm_; break b;}
          var i = 0;
          for(;;){
           var k = [0, 11], j = 0;
           c:
