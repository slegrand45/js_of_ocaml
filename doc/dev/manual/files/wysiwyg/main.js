...
(function(globalThis){
    ...
    for(;;){
     a:
     {
      if(param){
       ...
       b:
       {
        try{var val = caml_call1(hd, e);}catch(_d__){break b;}
   ...
   function wakeup(r, v){
    var result$0 = [0, v], p = underlying(r), _dy_ = p[1];
    switch(_dy_[0]){
      case 1:
   ...
   function html2wiki(body){
    ...
    function add_str(opt, s){
     ...
     try{
      var i = 0;
      for(;;){
       if(len <= i){var _du_ = 0, _dv_ = _du_; break;}
       if
