...
(function(globalThis){
      ...
      case 5:
       ...
       for(;;){
        if(i$0 === len)
         ...
         var _es_ = caml_string_get(str, i$0) - 46 | 0;
         a:
         {
          if(23 < _es_ >>> 0){
           if(55 === _es_) break a;
          }
          else if(21 < _es_ - 1 >>> 0) break a;
    ...
    for(;;){
     a:
     {
      if(param){
       ...
       b:
       {
        try{var val = caml_call1(hd, e);}catch(_ed_){break b;}
   ...
   function wakeup(r, v){
    var result$0 = [0, v], p = underlying(r), _dK_ = p[1];
    switch(_dK_[0]){
      case 1:
           ...
           for(;;){
            ...
            if(2 >= ocaml_lex_state$2 >>> 0)
             switch(ocaml_lex_state$2){
               ...
               default:
                var _dk_ = c[9]; c[9] = [0, lexeme(lexbuf), _dk_]; break b;
             }
            caml_call1(lexbuf[1], lexbuf);
